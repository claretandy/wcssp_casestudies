...
start='201911140000' # Format YYYYMMDDHHMM
end='201911160000' # Format YYYYMMDDHHMM
...
event_location_name='Terengganu' # A short name to decribe the location of the event
event_region_name='PeninsularMalaysia' # This should be a large region for which you can group events together (e.g. Luzon, Java, Terrengganu)
######################################################################################################################
